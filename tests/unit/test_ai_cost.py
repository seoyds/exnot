...
class TestCostTracker:
    ...
    def test_record_adds_cost(self):
        ...
        cost = tracker.record("test_task", "google/gemini-2.5-flash", usage)
    ...
    def test_budget_tracking(self):
        ...
        tracker.record("expensive_task", "anthropic/claude-sonnet-4-20250514", usage)
    ...
    def test_summary(self):
        ...
        tracker.record("task1", "google/gemini-2.5-flash", usage)
    ...
    def test_multiple_calls(self):
        ...
        for i in range(3):
            usage = Usage(input_tokens=1000, output_tokens=200, requests=1)
            tracker.record(f"task_{i}", "google/gemini-2.5-flash", usage)
